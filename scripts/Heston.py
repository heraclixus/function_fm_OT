"""
FFM Experiments on Heston Stochastic Volatility Data.

This script runs baseline FFM experiments (without OT) on Heston
...
# Data params
n_samples = 5000
n_x = 100  # Time steps (will be n_steps + 1 from Heston)

# Generate dataset
print("Generating Heston dataset...")
dataset = generate_heston_dataset(
    n_samples=n_samples,
    n_steps=n_x - 1,  # To get n_x points total
    T=1.0,
    mu=0.05,
    kappa=1.0,
    theta=0.04,
...
# Output directory
spath = Path('../outputs/Heston_baseline/')
