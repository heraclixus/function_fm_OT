"""
FFM Experiments on Stochastic KdV Data.

This script runs baseline FFM experiments on stochastic Korteweg-de Vries 
equation solutions, comparing:
...
Usage:
    python stochastic_kdv.py
    python stochastic_kdv.py --epochs 100
"""
...
def parse_args():
    parser = argparse.ArgumentParser('stochastic_kdv_experiment')
    ...
    parser.add_argument('--spath', help='Path to save outputs', type=str,
                        default='../outputs/stochastic_kdv_baseline/')
    ...
    # Training params
    parser.add_argument('--ntr', help='Number of training samples', type=int, default=50000)
...
def main():
    ...
    data = load_stochastic_kdv(args.dpath, shuffle=True, mode=args.mode, 
    ...
    n_x = train_data.shape[-1]  # Should be 128 for stochastic KdV
